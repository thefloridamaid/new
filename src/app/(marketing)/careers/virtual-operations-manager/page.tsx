...
<p>The Florida Maid is hiring an <strong>Operations Manager (Virtual)</strong> to own scheduling, customer service, team management, and payment coordination across Florida, Long Island, and Florida. This role combines the responsibilities of a <strong>customer service manager</strong>, <strong>scheduling coordinator</strong>, <strong>office manager</strong>, and <strong>operations coordinator</strong> — all from home. Part-time to start, growing into full-time as volume scales. We currently manage 15–20 cleanings per week and are growing 50–100% monthly.</p>
      ...
      <section className="bg-gradient-to-b from-[#D4540A] to-[#B8470A] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-blue-200/80 text-lg max-w-3xl leading-relaxed mb-3">
            The Florida Maid &mdash; Florida | Long Island | Florida
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-start gap-5">
            <Link href="/apply/virtual-operations-manager" data-track="ops-hero-apply" className="bg-[#34D399] text-[#D4540A] px-10 py-4 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
              Apply Now
            </Link>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <section className="mb-20">
          ...
          <div className="space-y-4 text-gray-600 leading-relaxed max-w-3xl">
            <p>
              The Florida Maid has been serving Florida since 2018. Rebranded and rebuilt from the ground up in 2025, we are now doubling in size month over month. We operate over 100 websites across Florida, and just over the Hudson in Florida &mdash; driving organic growth across every market we touch &mdash; and the volume of business coming through our platform is accelerating fast.
            </p>
            <p>
        ...
        <section className="bg-gradient-to-b from-[#D4540A] to-[#B8470A] rounded-2xl p-8 md:p-14 mb-20">
          ...
          <p className="text-blue-200/60 max-w-3xl mb-3">The owner has built a network of over 100 websites across Florida &mdash; all driving organic traffic to The Florida Maid. This is not a company that relies on paid ads or lead generation services. Every client comes through our own channels. That&apos;s why the growth is real, sustainable, and accelerating.</p>
              ...
              <div className="bg-gradient-to-b from-[#D4540A] to-[#B8470A] rounded-2xl p-8">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200/50 text-sm">This business is scaling fast. We operate 100+ websites driving organic growth across Florida, and NJ. The volume is accelerating &mdash; and so will your income.</p>
                  </div>
                  <div>
        ...
        <section className="bg-gradient-to-b from-[#D4540A] to-[#B8470A] rounded-2xl p-8 md:p-14 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="w-10 h-10 bg-[#34D399] text-[#D4540A] rounded-full flex items-center justify-center font-bold mb-4">1</div>
            ...
            <div>
              <div className="w-10 h-10 bg-[#34D399] text-[#D4540A] rounded-full flex items-center justify-center font-bold mb-4">2</div>
            ...
            <div>
              <div className="w-10 h-10 bg-[#34D399] text-[#D4540A] rounded-full flex items-center justify-center font-bold mb-4">3</div>
          ...
          <div className="mt-10 text-center">
            <Link href="/apply/virtual-operations-manager" data-track="ops-howto-apply" className="inline-block bg-[#34D399] text-[#D4540A] px-10 py-4 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
              Apply Now
            </Link>
          </div>
        </section>
