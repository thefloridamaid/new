      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-[#1E2A4A] rounded-xl p-8 my-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="tel:8333526243" className="bg-[#A8F0DC] text-[#1E2A4A] px-8 py-3.5 rounded-md font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
              Call (833) 352-6243
            </a>
