...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.thefloridamaid.com/nyc-maid-service-services-offered-by-the-nyc-maid' },
  openGraph: {
    ...
    url: 'https://www.thefloridamaid.com/nyc-maid-service-services-offered-by-the-nyc-maid',
  },
}
    ...
    <>
      ...
      <section className="pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#D4540A] tracking-wide text-center mb-14">Choose the Service That Fits Your Needs</p>
            ...
            {SERVICES.map(service => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-[#D4540A] font-bold text-sm whitespace-nowrap ml-4">From {service.priceRange.split('–')[0]}</span>
                </div>
      ...
      <section className="py-20 bg-[#34D399]">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-[#D4540A]/70 max-w-2xl mx-auto mb-10">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.title} className="border border-gray-200 rounded-xl p-5">
                <p className="text-[#D4540A] font-semibold text-sm mb-1">{item.title}</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl text-[#D4540A] tracking-wide mb-4">All Services Available in Every Area We Serve</p>
          <p className="text-gray-500 max-w-2xl mx-auto mb-8">
            Every service listed above is available in all of our coverage areas. Same rates, same quality — whether you&apos;re in the <Link href="/upper-east-side-maid-service" className="text-[#D4540A] underline underline-offset-2">Upper East Side</Link>, <Link href="/williamsburg-maid-service" className="text-[#D4540A] underline underline-offset-2">Williamsburg</Link>, <Link href="/astoria-maid-service" className="text-[#D4540A] underline underline-offset-2">Astoria</Link>, <Link href="/great-neck-maid-service" className="text-[#D4540A] underline underline-offset-2">Great Neck</Link>, or <Link href="/hoboken-maid-service" className="text-[#D4540A] underline underline-offset-2">Hoboken</Link>.
          </p>
