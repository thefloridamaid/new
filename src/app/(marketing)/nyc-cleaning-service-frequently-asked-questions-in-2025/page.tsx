      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-blue-200/80 text-lg max-w-2xl leading-relaxed mb-10">
            Everything you need to know about pricing, services, scheduling, and how we work — answered by our team. Can&apos;t find your question? Call <a href="tel:8333526243" className="text-[#A8F0DC] underline underline-offset-2">(833) 352-6243</a>.
          </p>
