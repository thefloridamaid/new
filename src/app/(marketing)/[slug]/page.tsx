            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
              <div className="lg:col-span-3">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  <a href="sms:8333526243" className="bg-[#A8F0DC] text-[#1E2A4A] px-8 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
                    Text (833) 352-6243
                  </a>
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-2xl p-7 shadow-xl">
                  ...
                  <a href="sms:8333526243" className="block text-center bg-[#A8F0DC] text-[#1E2A4A] px-6 py-3.5 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
                    Text to Book
                  </a>
                </div>
              </div>
        ...
        <section className="bg-white border-b border-gray-100 pt-14 md:pt-20 pb-0">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <a href="sms:8333526243" className="bg-[#1E2A4A] text-white px-10 py-4 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                Text (833) 352-6243
              </a>
              <a href="tel:8333526243" className="text-[#1E2A4A] font-semibold py-4 hover:underline underline-offset-4">
                or Call Us
              </a>
            </div>
          </div>
