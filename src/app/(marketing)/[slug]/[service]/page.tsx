          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="bg-[#F5FBF8] border border-[#A8F0DC]/30 rounded-2xl p-6 text-center">
                ...
                <a href="sms:8333526243" className="inline-block bg-[#A8F0DC] text-[#1E2A4A] px-6 py-3 rounded-lg font-bold text-xs tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors w-full">
                  Get a Free Quote
                </a>
              </div>
            </div>
