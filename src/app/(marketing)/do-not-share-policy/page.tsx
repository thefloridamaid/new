        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-xl p-5 mt-4 space-y-2">
              <p className="text-gray-600 text-sm">Email us at <a href="mailto:hi@thefloridamaid.com" className="text-[#1E2A4A] underline underline-offset-2">hi@thefloridamaid.com</a> with the subject &ldquo;Do Not Share&rdquo;</p>
              <p className="text-gray-600 text-sm">Or text/call <a href="tel:8333526243" className="text-[#1E2A4A] underline underline-offset-2">(833) 352-6243</a></p>
            </div>
