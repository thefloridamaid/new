...
export const metadata: Metadata = {
  ...
  description: 'The Florida Maid does not sell, share, or distribute your personal information. Your data stays with us. Florida cleaning from $49/hr. (833) 352-6243',
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#D4540A] tracking-wide mb-4">What We Do Collect</h2>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <span className="text-[#D4540A]/30 mt-0.5 flex-shrink-0">&#8226;</span>
          ...
          <div>
            <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#D4540A] tracking-wide mb-4">Your Rights Under CCPA &amp; Other Privacy Laws</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <div className="bg-gray-50 rounded-xl p-5 mt-4 space-y-2">
              <p className="text-gray-600 text-sm">Email us at <a href="mailto:hi@thefloridamaid.com" className="text-[#D4540A] underline underline-offset-2">hi@thefloridamaid.com</a> with the subject &ldquo;Do Not Share&rdquo;</p>
              <p className="text-gray-600 text-sm">Or text/call <a href="tel:8333526243" className="text-[#D4540A] underline underline-offset-2">(833) 352-6243</a></p>
            </div>
          ...
          <div>
            <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#D4540A] tracking-wide mb-4">Data Deletion</h2>
            <p className="text-gray-600 leading-relaxed">
