    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#1E2A4A] to-[#243352] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <a href="sms:8333526243" className="inline-block font-[family-name:var(--font-bebas)] text-4xl md:text-5xl text-[#A8F0DC] tracking-wide hover:text-white transition-colors">
            (833) 352-6243
          </a>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-2xl p-8 text-center hover:border-[#A8F0DC] hover:shadow-lg transition-all">
              ...
              <a href="sms:8333526243" className="text-[#1E2A4A] text-xl font-bold hover:underline underline-offset-4">(833) 352-6243</a>
              <p className="text-gray-500 text-sm mt-3">Fastest way to reach us. Most quotes delivered within 15 minutes.</p>
              <div className="flex flex-col gap-2 mt-5">
                <a href="sms:8333526243" className="bg-[#A8F0DC] text-[#1E2A4A] px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#8DE8CC] transition-colors">
                  Text Us
                </a>
                <a href="tel:8333526243" className="text-[#1E2A4A] font-semibold text-sm py-2 hover:underline underline-offset-4">
                  or Call
                </a>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-2xl p-8 text-center hover:border-[#A8F0DC] hover:shadow-lg transition-all">
              ...
              <a href="mailto:hi@thefloridamaid.com" className="text-[#1E2A4A] text-lg font-bold hover:underline underline-offset-4">hi@thefloridamaid.com</a>
              <p className="text-gray-500 text-sm mt-3">For detailed requests, photos, or questions. We respond within 2 hours.</p>
              <a href="mailto:hi@thefloridamaid.com" className="inline-block mt-5 bg-[#1E2A4A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#1E2A4A]/90 transition-colors">
                Send Email
              </a>
            </div>
            ...
            <div className="border border-gray-200 rounded-2xl p-8 text-center hover:border-[#A8F0DC] hover:shadow-lg transition-all">
              ...
              <p className="text-[#1E2A4A] text-lg font-bold">thefloridamaid.com/book</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              ...
              <div className="bg-gray-50 rounded-xl p-5">
                ...
                <p className="text-[#1E2A4A] font-medium">Miami, FL 33101</p>
