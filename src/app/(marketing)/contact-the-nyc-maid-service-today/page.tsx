...
const url = 'https://www.thefloridamaid.com/contact-the-nyc-maid-service-today'
const title = 'Contact The Florida Maid | Call or Text (833) 352-6243 | Free Quote'
const description = 'Contact The Florida Maid for a free cleaning quote. Text or call (833) 352-6243, email hi@thefloridamaid.com, or book online. Service from $49/hr across Florida. 5.0★ Google.'
...
const contactFaqs = [
  { question: 'What\'s the fastest way to get a quote?', answer: 'Text (833) 352-6243 with your address, home size (bedrooms/bathrooms), and what type of cleaning you need. Most quotes are delivered within 15 minutes.' },
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-2xl p-8 text-center hover:border-[#34D399] hover:shadow-lg transition-all">
              ...
              <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#D4540A] tracking-wide mb-2">Email Us</h2>
              <a href="mailto:hi@thefloridamaid.com" className="text-[#D4540A] text-lg font-bold hover:underline underline-offset-4">hi@thefloridamaid.com</a>
              <p className="text-gray-500 text-sm mt-3">For detailed requests, photos, or questions. We respond within 2 hours.</p>
              <a href="mailto:hi@thefloridamaid.com" className="inline-block mt-5 bg-[#D4540A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#D4540A]/90 transition-colors">
                Send Email
              </a>
            </div>
            ...
            <div className="border border-gray-200 rounded-2xl p-8 text-center hover:border-[#34D399] hover:shadow-lg transition-all">
              ...
              <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#D4540A] tracking-wide mb-2">Book Online</h2>
              <p className="text-[#D4540A] text-lg font-bold">thefloridamaid.com/book</p>
              <p className="text-gray-500 text-sm mt-3">Submit your details online and we&apos;ll confirm your appointment within the hour.</p>
              <Link href="/book/new" className="inline-block mt-5 bg-[#D4540A] text-white px-6 py-3 rounded-lg font-bold text-sm tracking-widest uppercase hover:bg-[#D4540A]/90 transition-colors">
                Book Now
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h2 className="font-[family-name:var(--font-bebas)] text-2xl text-[#D4540A] tracking-wide mb-6">Hours &amp; Location</h2>
              <div className="space-y-4 mb-4">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="text-gray-700 font-medium">Monday – Saturday</span>
                  <span className="text-[#D4540A] font-bold">7:00 AM – 7:00 PM</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <div className="bg-gray-50 rounded-xl p-5">
                ...
                <p className="text-[#D4540A] font-medium">Miami, FL 33101</p>
                <p className="text-gray-500 text-sm mt-1">Serving all Florida counties we serve, Long Island &amp; NJ</p>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#D4540A] tracking-wide text-center mb-4">Same Rates Across Every Location</p>
      ...
      <section className="py-12 bg-[#34D399]">
        <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-start gap-6">
          ...
          <div>
            <h3 className="font-[family-name:var(--font-bebas)] text-xl text-[#D4540A] tracking-wide mb-2">Our Response Time Promise</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="font-[family-name:var(--font-bebas)] text-3xl md:text-4xl text-[#D4540A] tracking-wide text-center mb-12">Contact FAQ</p>
