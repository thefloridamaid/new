        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-6 text-center">
            ...
            <div>
              ...
              <p className="text-[#1E2A4A]/60 text-sm font-medium">Florida</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="bg-[#A8F0DC] rounded-2xl p-8 md:p-12 text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <a href="sms:8333526243" className="text-[#1E2A4A] font-semibold underline underline-offset-4 hover:no-underline">
              or Text (833) 352-6243
            </a>
          </div>
        </section>
