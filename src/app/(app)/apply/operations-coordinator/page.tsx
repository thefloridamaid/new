        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          <div className="my-5 p-4 border border-gray-200 rounded-lg bg-gray-50">
            <label className="flex items-start gap-3 cursor-pointer text-[13px] leading-relaxed text-gray-600">
              ...
              <span>
                By checking this box, I consent to receive text messages from <strong>The Florida Maid</strong> regarding my application. Reply STOP to opt out. Msg &amp; data rates may apply.
                <br /><br />
                Al marcar esta casilla, doy mi consentimiento para recibir mensajes de texto de <strong>The Florida Maid</strong> sobre mi solicitud. Responda STOP para cancelar.
                <br /><br />
