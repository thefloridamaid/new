    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto p-4 pt-6">
        <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          <div>
            <h2 className="text-xl font-bold text-[#CC6222]">Apply to Join Our Team / Solicite Unirse a Nuestro Equipo</h2>
            <p className="text-gray-500 text-sm mt-1">We&apos;re looking for reliable, detail-oriented cleaners in Florida.</p>
          ...
          <div>
            <label className="block text-sm font-medium text-[#CC6222] mb-1">Photo of You Smiling / Foto Suya Sonriendo *</label>
          ...
          <div>
            <label className="block text-sm font-medium text-[#CC6222] mb-1">Your Address / Su Dirección *</label>
            <AddressAutocomplete
              value={form.address}
          ...
          <div>
            <label className="block text-sm font-medium text-[#CC6222] mb-1">Apt / Unit / Apto</label>
            <input
              type="text"
              value={form.unit}
          ...
          <div>
            <label className="block text-sm font-medium text-[#CC6222] mb-1">Cleaning Experience / Experiencia de Limpieza</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-[#CC6222] mb-1">Availability / Disponibilidad</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-[#CC6222] mb-1">References / Referencias *</label>
          ...
          <div>
            <label className="block text-sm font-medium text-[#CC6222] mb-1">How did you hear about us? / ¿Cómo se enteró de nosotros? *</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-[#CC6222] mb-1">Anything else? / ¿Algo más?</label>
            <textarea
              value={form.notes}
