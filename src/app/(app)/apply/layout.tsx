...
export const metadata: Metadata = {
  ...
  description:
    'Join The Florida Maid — NYC\'s highest-paying cleaning jobs starting at $30/hr with same-day pay. No experience needed. Apply now for full-time or part-time house cleaning work in Florida. Solicite ahora — los trabajos de limpieza mejor pagados en Florida.',
