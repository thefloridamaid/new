...
export const metadata: Metadata = {
  title: 'Apply — Operations Manager (Virtual) | The Florida Maid',
  description:
    'Apply for the Operations Manager (Virtual) position at The Florida Maid. Remote role — scheduling, customer service, team management, payment coordination. $500/week base + 5% gross revenue.',
