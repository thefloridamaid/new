  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 w-full max-w-md">
        <h1 className="text-2xl font-semibold text-[#D4540A] mb-1">Anonymous Feedback</h1>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit}>
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-xl text-[#D4540A] text-sm resize-none focus:outline-none focus:border-[#D4540A]"
              rows={5}
              required
            />
            <button
              ...
              className="w-full mt-4 py-3 bg-[#D4540A] text-white rounded-xl font-medium disabled:bg-gray-300"
            >
