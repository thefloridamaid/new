...
export default function DocsPage() {
  ...
  return (
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 p-3 md:p-6">
        ...
        {s === 'overview' && (
          <div>
            <h1 className="text-3xl font-bold text-[#1E2A4A] mb-2">The Florida Maid Platform</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <Card title="" accent="blue">
                ...
                <p><strong>GitHub:</strong> <a href="https://github.com/theflmaid/flmaid" className="underline py-1.5 inline-block">theflmaid/flmaid</a></p>
              </Card>
              <Card title="" accent="blue">
                <p><strong>Vercel:</strong> <a href="https://vercel.com/jeff-tuckers-projects/flmaid" className="underline py-1.5 inline-block">jeff-tuckers-projects/flmaid</a></p>
        ...
        {s === 'platform-map' && (
          <div>
            ...
            <T headers={['Route', 'What it does']} rows={[
              ...
              ['/clients/reschedule/[id]', 'Reschedule an existing booking'],
            ]} />
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li><strong>Delivery</strong> — Emailed to thefloridamaid@gmail.com + creates dashboard notification</li>
            </ul>
          </div>
        )}
        ...
        {s === 'pages' && (
          <div>
            ...
            <T headers={['File', 'Route', 'Purpose']} rows={[
              ...
              ['book/reschedule/[id]/page.tsx', '/clients/reschedule/:id', 'Self-service reschedule'],
            ]} />
        ...
        {s === 'selena' && (
          <div>
            ...
            <T headers={['Topic', 'Key Info']} rows={[
              ['Pricing', '$49/hr (client supplies), $65/hr (company supplies), $100/hr emergency, 2hr minimum'],
        ...
        {s === 'bookings' && (
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li><strong>Hourly rates</strong> — $49/hr, $65/hr, $100/hr</li>
        ...
        {s === 'emails' && (
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li><strong>Payment reminder</strong> — Zelle (hi@thefloridamaid.com) / Apple Pay 15 minutes before service</li>
...
git push origin main`}
            ...
            <T headers={['Service', 'URL']} rows={[
              ...
              ['Vercel', 'vercel.com/jeff-tuckers-projects/flmaid'],
              ['GitHub', 'github.com/theflmaid/flmaid'],
...
curl -b "admin_authenticated=true" https://www.thefloridamaid.com/api/dashboard

# Check build
npm run build 2>&1 | head -50

# Read docs as JSON
curl https://www.thefloridamaid.com/api/docs | jq .`}
            </pre>
          </div>
        )}
