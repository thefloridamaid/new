  ...
  if (!connected) {
    return (
      <main className="p-3 md:p-6 max-w-4xl">
        <h2 className="text-2xl font-bold text-[#CC6222] mb-1">Google Business Profile</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-6">
          <h3 className="text-lg font-semibold text-[#CC6222] mb-4">Setup Instructions</h3>

          <div className="space-y-4">
            <div className="flex gap-3">
              <span className="flex-shrink-0 w-7 h-7 bg-[#CC6222] text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
              <div>
                <p className="font-medium text-[#CC6222]">Create a Google Cloud Project</p>
            ...
            <div className="flex gap-3">
              <span className="flex-shrink-0 w-7 h-7 bg-[#CC6222] text-white rounded-full flex items-center justify-center text-sm font-bold">2</span>
              <div>
                <p className="font-medium text-[#CC6222]">Enable the Business Profile APIs</p>
                <p className="text-sm text-gray-500 mt-0.5">
            ...
            <div className="flex gap-3">
              <span className="flex-shrink-0 w-7 h-7 bg-[#CC6222] text-white rounded-full flex items-center justify-center text-sm font-bold">3</span>
              <div>
                <p className="font-medium text-[#CC6222]">Create OAuth 2.0 Credentials</p>
                <p className="text-sm text-gray-500 mt-0.5">
                  Go to APIs &amp; Services &gt; Credentials &gt; Create Credentials &gt; OAuth client ID.
                  Choose &quot;Web application&quot;. Add authorized redirect URI:
                </p>
                <code className="block mt-1 text-sm bg-gray-100 rounded px-3 py-2 text-[#CC6222] break-all">
            ...
            <div className="flex gap-3">
              <span className="flex-shrink-0 w-7 h-7 bg-[#CC6222] text-white rounded-full flex items-center justify-center text-sm font-bold">4</span>
              <div>
                <p className="font-medium text-[#CC6222]">Configure OAuth Consent Screen</p>
                <p className="text-sm text-gray-500 mt-0.5">
            ...
            <div className="flex gap-3">
              <span className="flex-shrink-0 w-7 h-7 bg-[#CC6222] text-white rounded-full flex items-center justify-center text-sm font-bold">5</span>
              <div>
                <p className="font-medium text-[#CC6222]">Add credentials to .env.local</p>
                <div className="mt-1 bg-gray-100 rounded-lg px-3 py-2 text-sm font-mono text-[#CC6222] space-y-0.5">
            ...
            <div className="flex gap-3">
              <span className="flex-shrink-0 w-7 h-7 bg-[#34D399] text-white rounded-full flex items-center justify-center text-sm font-bold">6</span>
              <div>
                <p className="font-medium text-[#CC6222]">Connect</p>
                <p className="text-sm text-gray-500 mt-0.5">
        ...
        <button
          ...
          className="px-6 py-3 bg-[#CC6222] text-white rounded-xl hover:bg-[#CC6222]/90 font-semibold text-sm shadow-sm transition-colors"
        >
  ...
  return (
    <main className="p-3 md:p-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-start mb-2">
        <div>
          <h2 className="text-2xl font-bold text-[#CC6222]">Google Business Profile</h2>
        ...
        {(['overview', 'reviews', 'insights'] as const).map(t => (
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium transition-all capitalize ${
              tab === t ? 'bg-[#CC6222] text-white shadow-sm' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
            }`}
          >
            {t}
          </button>
              ...
              <div className="space-y-3 mb-8">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-medium text-[#CC6222]">{review.reviewer}</span>
                      ...
                      {replyDraft[review.id] !== undefined ? (
                        <div className="space-y-2">
                          <textarea
                            ...
                            className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-[#CC6222] focus:ring-2 focus:ring-[#CC6222] outline-none resize-none"
                            rows={3}
                          />
                          <div className="flex gap-2">
                            <button
                              ...
                              className="px-4 py-2 bg-[#CC6222] text-white rounded-lg text-sm font-medium hover:bg-[#CC6222]/90 disabled:opacity-50"
                            >
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="px-4 py-2 bg-[#34D399]/20 text-white rounded-lg text-sm font-medium hover:bg-[#34D399]/30 disabled:opacity-50 border border-[#34D399]/30"
                          >
                ...
                {unrepliedCount > 3 && (
                  <button
                    ...
                    className="text-sm text-[#CC6222] font-medium hover:underline"
                  >
        ...
        <>
            ...
            {(['all', 'unreplied', '5', '4', '3', '2', '1'] as const).map(f => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm font-medium transition-all ${
                  reviewFilter === f ? 'bg-[#CC6222] text-white shadow-sm' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                }`}
              >
          ...
          {filteredReviews.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-xl border border-gray-100 shadow-sm">
              <h3 className="text-lg font-semibold text-[#CC6222] mb-1">No reviews found</h3>
      ...
      {tab === 'insights' && (
        <>
          {insights ? (
            ...
            <div className="text-center py-16 bg-white rounded-xl border border-gray-100 shadow-sm">
              <h3 className="text-lg font-semibold text-[#CC6222] mb-1">No insights data yet</h3>
