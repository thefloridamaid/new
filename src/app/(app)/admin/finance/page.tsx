...
export default function FinancePage() {
  useEffect(() => { document.title = 'Finance | The Florida Maid Cleaning Service Cleaning Service' }, [])
    ...
    <>
      <main className="p-3 md:p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-[#CC6222]">Finance</h2>
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#CC6222] text-white rounded-xl hover:bg-[#CC6222]/90 text-sm transition-colors"
            >
              + Add Expense
            </button>
          </div>
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
                  <h3 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider">👥 PAYROLL</h3>
                  {pendingPayments.length > 0 && (
                    <button
                      onClick={() => setActiveTab('payroll')}
                      className="py-2 text-xs text-[#CC6222] hover:underline font-medium"
                    >
                  ...
                  {summary?.cleanerTotals && summary.cleanerTotals.length > 0 ? (
                    summary.cleanerTotals.map(c => (
                      <div key={c.cleaner_id} className="flex items-center justify-between px-5 py-3 hover:bg-gray-50 transition-colors">
                        <div>
                          <p className="font-medium text-[#CC6222] text-sm">{c.name}</p>
                ...
                {summary?.cleanerTotals && summary.cleanerTotals.length > 0 && (
                  <div className="flex items-center justify-between px-5 py-3 bg-gray-50 border-t border-gray-100">
                    <span className="font-bold text-[#CC6222] text-sm">Total Owed</span>
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
                  <h3 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider">🧾 EXPENSES</h3>
                  <button
                  ...
                  {expenses.length > 0 ? (
                    expenses.slice(0, 6).map(exp => (
                      <div key={exp.id} className="flex items-center justify-between px-5 py-3 hover:bg-gray-50 transition-colors">
                        <div>
                          <p className="font-medium text-[#CC6222] text-sm">{exp.description}</p>
                ...
                <div className="flex items-center justify-between px-5 py-3 bg-gray-50 border-t border-gray-100">
                  <span className="font-bold text-[#CC6222] text-sm">Total (Month)</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100">
                  <h3 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider">⏳ PENDING</h3>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100">
                  <h3 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider">📊 MARGIN ANALYSIS</h3>
                </div>
                <div className="p-5">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wide">Gross Margin</p>
                      <p className="text-2xl font-bold text-[#CC6222]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100">
                  <h3 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider">💰 THIS MONTH</h3>
                </div>
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex justify-between pt-3 border-t border-gray-100">
                    <span className="font-bold text-[#CC6222]">Profit</span>
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100">
                  <h3 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider">📅 YEAR TO DATE</h3>
                </div>
                <div className="p-5 space-y-3">
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Revenue</span>
          ...
          <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {summary.cleanerTotals.map(c => (
                    <div key={c.cleaner_id} className="bg-white rounded-xl p-3 border border-orange-100">
                      <p className="font-medium text-[#CC6222]">{c.name}</p>
                  ...
                  <tbody>
                    {pendingPayments.map((p) => (
                      <tr key={p.id} className="border-b border-gray-100">
                        ...
                        <td className="p-4 font-medium text-[#CC6222]">{p.client_name}</td>
            ...
            {summary?.recentPayments && summary.recentPayments.length > 0 && (
              <div className="mt-8">
                <h3 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider mb-4">✅ RECENT PAYMENTS</h3>
                <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                  <div className="overflow-x-auto">
          ...
          <div className="space-y-4">
            ...
            {expenses.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <button onClick={() => setShowExpenseModal(true)} className="mt-2 text-[#CC6222] hover:underline">Add your first expense</button>
              </div>
            ) : (
              <>
              <div className="flex justify-between items-center mb-4">
                <span></span>
                <button onClick={() => exportCSV('expenses')} className="text-sm text-[#CC6222] hover:underline">Export CSV</button>
              </div>
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div className="overflow-x-auto">
                <table className="w-full min-w-[700px]">
                  ...
                  <tbody>
                    {expenses.map((exp) => (
                      <tr key={exp.id} className="border-b border-gray-100">
                        ...
                        <td className="p-4 text-[#CC6222]">{exp.description}</td>
                        <td className="p-4 text-gray-600">{exp.vendor || '-'}</td>
                        <td className="p-4 font-medium text-[#CC6222]">{formatCurrencyDecimal(exp.amount)}</td>
                        <td className="p-4">
                          {exp.receipt_url ? (
                            <a href={exp.receipt_url} target="_blank" rel="noopener noreferrer" className="text-[#CC6222] hover:underline text-sm">View</a>
                          ) : (
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider">🏦 BANK STATEMENTS</h3>
              <button
                onClick={() => setShowStatementModal(true)}
                className="px-4 py-2 bg-[#CC6222] text-white rounded-xl hover:bg-[#CC6222]/90 text-sm"
              >
                Upload Statement
              </button>
            </div>
            ...
            {statements.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <button onClick={() => setShowStatementModal(true)} className="mt-2 text-[#CC6222] hover:underline">Upload your first statement</button>
              </div>
            ) : (
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div className="overflow-x-auto">
                  ...
                  <tbody>
                    {statements.map((stmt) => (
                      <tr key={stmt.id} className="border-b border-gray-100">
                        <td className="p-4 font-medium text-[#CC6222]">
                        ...
                        <td className="p-4">
                          {stmt.file_url ? (
                            <a href={stmt.file_url} target="_blank" rel="noopener noreferrer" className="text-[#CC6222] hover:underline text-sm">Download PDF</a>
                          ) : (
          ...
          <div className="space-y-4">
            <div className="bg-[#34D399]/20 border border-[#34D399]/30 rounded-xl p-5 mb-4">
              <div className="flex justify-between items-center">
                <div>
                  <h4 className="text-xs font-bold text-[#CC6222] uppercase tracking-wider">📋 1099 YEAR-END REPORT</h4>
                  <p className="text-sm text-[#CC6222] mt-1">Total paid to each contractor for tax year {new Date().getFullYear()}</p>
                </div>
                <button onClick={() => exportCSV('1099')} className="px-4 py-2 bg-[#CC6222] text-white rounded-xl hover:bg-[#CC6222]/90 text-sm">
                  Export CSV
                </button>
              </div>
            </div>
                  ...
                  <tbody>
                    {summary.cleanerTotals.map((c) => (
                      <tr key={c.cleaner_id} className="border-b border-gray-100">
                        <td className="p-4 font-medium text-[#CC6222]">{c.name}</td>
                        <td className="p-4 text-gray-600">{c.count} jobs</td>
                        <td className="p-4 font-semibold text-[#CC6222]">{formatCurrency(c.total)}</td>
                        <td className="p-4">
                          {c.total >= 60000 ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3 items-center">
              <select
                ...
                className="px-3 py-2 border border-gray-300 rounded-lg text-[#CC6222] text-sm"
              >
              ...
              {incomeDateRange === 'custom' && (
                <div className="flex gap-2 items-center">
                  <input
                    ...
                    className="px-3 py-1.5 border border-gray-300 rounded-lg text-[#CC6222] text-sm"
                  />
              ...
              <button
                ...
                className="ml-auto text-sm text-[#CC6222] hover:underline"
              >
                Export CSV
              </button>
            </div>
                    ...
                    {cleanerIncomeData.cleanerSummaries.map(cs => (
                      <button
                        ...
                        className={`bg-white border rounded-xl p-4 text-left hover:shadow-sm transition-all ${
                          incomeCleanerFilter === cs.cleaner_id ? 'border-[#CC6222] ring-2 ring-[#CC6222]/20' : 'border-gray-200'
                        }`}
                      >
                        <p className="font-medium text-[#CC6222]">{cs.name}</p>
                        <p className="text-xl font-bold text-[#CC6222] mt-1">{formatCurrency(cs.totalPay)}</p>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4">
                      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
                        <div>
                          ...
                          <p className="text-lg font-bold text-[#CC6222]">{formatCurrency(totals.income)}</p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-500">Total Jobs</p>
                          <p className="text-lg font-bold text-[#CC6222]">{totals.jobs}</p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-500">Total Hours</p>
                          <p className="text-lg font-bold text-[#CC6222]">{totals.hours}</p>
                        </div>
                        <div>
                        ...
                        <tbody>
                          {cleanerIncomeData.bookings.map((b) => (
                            <tr key={b.id} className="border-b border-gray-100">
                              ...
                              <td className="p-4 font-medium text-[#CC6222]">{b.client_name}</td>
                              <td className="p-4 text-gray-600">{b.cleaner_name}</td>
                              <td className="p-4 text-gray-600">{b.hours}hrs</td>
                              <td className="p-4 font-semibold text-[#CC6222]">{formatCurrencyDecimal(b.cleaner_pay)}</td>
                              <td className="p-4">
                                {b.paid ? (
      ...
      {/* Add Expense Modal */}
      {showExpenseModal && (
        <div className="fixed inset-0 bg-[#CC6222]/50 backdrop-blur-sm flex items-center justify-center z-50" onClick={() => setShowExpenseModal(false)}>
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl" onClick={e => e.stopPropagation()}>
            <h3 className="text-lg font-bold text-[#CC6222] mb-4">Add Expense</h3>
            <form onSubmit={handleAddExpense} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Amount</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-7 pr-3 py-2 border border-gray-300 rounded-lg text-[#CC6222]"
                    placeholder="0.00"
                  />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Category</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Description</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Vendor (optional)</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Receipt (optional)</label>
                <input
                  type="file"
                  accept="image/*,.pdf"
                  onChange={(e) => setReceiptFile(e.target.files?.[0] || null)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-[#CC6222] text-sm"
                />
                {receiptFile && <p className="text-xs text-gray-500 mt-1">{receiptFile.name}</p>}
              </div>
              <div className="flex gap-3 pt-2">
                <button type="button" onClick={() => setShowExpenseModal(false)} className="flex-1 px-4 py-2 border border-gray-200 rounded-xl text-[#CC6222] hover:bg-gray-50 transition-colors">Cancel</button>
                <button type="submit" disabled={saving || uploading} className="flex-1 px-4 py-2 bg-[#CC6222] text-white rounded-xl hover:bg-[#CC6222]/90 transition-colors">
      ...
      {showStatementModal && (
        <div className="fixed inset-0 bg-[#CC6222]/50 backdrop-blur-sm flex items-center justify-center z-50" onClick={() => setShowStatementModal(false)}>
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl" onClick={e => e.stopPropagation()}>
            <h3 className="text-lg font-bold text-[#CC6222] mb-4">Upload Bank Statement</h3>
            <form onSubmit={handleAddStatement} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Month</label>
                <input
                  type="month"
                  required
              ...
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Account</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Statement PDF</label>
                <input
                  type="file"
                  accept=".pdf"
              ...
              <div>
                <label className="block text-sm font-medium text-[#CC6222] mb-1">Notes (optional)</label>
                <input
                  type="text"
              ...
              <div className="flex gap-3 pt-2">
                <button type="button" onClick={() => setShowStatementModal(false)} className="flex-1 px-4 py-2 border border-gray-200 rounded-xl text-[#CC6222] hover:bg-gray-50 transition-colors">Cancel</button>
                <button type="submit" disabled={saving || uploading} className="flex-1 px-4 py-2 bg-[#CC6222] text-white rounded-xl hover:bg-[#CC6222]/90 transition-colors">
