      ...
      <div className="p-4">
        ...
        {doNotService && (
          <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6 text-center">
            <p className="text-lg font-semibold text-[#CC6222] mb-2">Account Restricted</p>
        ...
        {!doNotService && nextBooking ? (
          <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
            ...
            <p className="text-2xl font-bold text-[#CC6222]">{getDaysUntil(nextBooking.start_time)}</p>
            ...
            <div className="flex gap-3 mt-4">
              {canReschedule(nextBooking) && (
                <button
                  ...
                  className="flex-1 py-2 border border-gray-300 rounded-lg text-[#CC6222] font-medium hover:bg-gray-50"
                >
                  Reschedule
                </button>
              )}
              <button
                ...
                className="flex-1 py-2 bg-[#CC6222] text-white rounded-lg font-medium hover:bg-[#CC6222]/90"
              >
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6 text-center">
            ...
            <button
              onClick={() => openBookingPanel()}
              className="mt-3 px-6 py-3 bg-[#CC6222] text-white rounded-lg font-medium hover:bg-[#CC6222]/90"
            >
              Ready for another service?
            </button>
        ...
        {showBooking && !doNotService && (
          <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold text-[#CC6222]">Book a Cleaning</h2>
              <button
            ...
            {bookingSuccess ? (
              <div className="text-center py-6">
                ...
                <p className="text-lg font-semibold text-[#CC6222]">Booking request submitted!</p>
                ...
                <button
                  onClick={() => setShowBooking(false)}
                  className="mt-4 px-6 py-2 bg-[#CC6222] text-white rounded-lg font-medium hover:bg-[#CC6222]/90"
                >
                  Done
                </button>
              </div>
              ...
              <>
                ...
                <div className="bg-[#34D399]/20 border border-[#34D399]/30 rounded-lg p-3 mb-4 text-sm">
                  <p className="text-[#CC6222]"><span className="font-medium">Same-day or emergency?</span> Please call or text us directly:</p>
                  <div className="flex gap-3 mt-2">
                    <a href="tel:9547103636" className="flex-1 py-2 bg-[#CC6222] text-white rounded-lg text-center font-medium text-sm hover:bg-[#CC6222]/90">Call (954) 710-3636</a>
                    <a href="sms:9547103636" className="flex-1 py-2 bg-[#CC6222] text-white rounded-lg text-center font-medium text-sm hover:bg-[#CC6222]/90">Text (954) 710-3636</a>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    min={minDate}
                    max={maxDate}
                    className="w-full border border-gray-300 rounded-lg p-3 text-[#CC6222] focus:outline-none focus:ring-2 focus:ring-[#CC6222]"
                  />
                </div>
                  ...
                  <div className="mb-4 space-y-3">
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {serviceTypes.map(s => (
                          ...
                          }} className={'p-2.5 rounded-lg border text-xs font-medium ' + (bookingServiceType === s ? 'border-[#CC6222] bg-[#CC6222] text-white' : 'border-gray-200 text-gray-700 hover:bg-gray-50')}>{s}</button>
                        ))}
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        }} className="w-8 h-8 rounded-lg border border-gray-300 flex items-center justify-center font-bold text-[#CC6222]" disabled={bookingHours <= 1}>-</button>
                        <span className="text-lg font-bold text-[#CC6222] min-w-[2rem] text-center">{bookingHours}</span>
                        <button type="button" onClick={() => {
                          if (bookingHours < 8) {
                            const h = bookingHours + 1
                            setBookingHours(h)
                        ...
                        }} className="w-8 h-8 rounded-lg border border-gray-300 flex items-center justify-center font-bold text-[#CC6222]" disabled={bookingHours >= 8}>+</button>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {bookingDate && !isSameDay(bookingDate) && bookingTime && (
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      className="w-full border border-gray-300 rounded-lg p-3 text-[#CC6222] text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[#CC6222]"
                      rows={3}
                    />
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-4 py-1.5 bg-[#CC6222] text-white text-sm rounded-lg font-medium hover:bg-[#CC6222]/90 disabled:opacity-50"
                        >
                ...
                {bookingDate && !isSameDay(bookingDate) && bookingTime && (
                  <div className="border-t border-gray-100 pt-4">
                    <div className="bg-gray-50 rounded-lg p-3 mb-4 text-sm">
                      <p className="text-gray-600"><span className="font-medium text-[#CC6222]">Date:</span> {formatPickedDate(bookingDate)}</p>
                      <p className="text-gray-600"><span className="font-medium text-[#CC6222]">Time:</span> {bookingTime}</p>
                      <p className="text-gray-600"><span className="font-medium text-[#CC6222]">Service:</span> {bookingServiceType} — ~{bookingHours} hrs</p>
                      <p className="text-gray-600"><span className="font-medium text-[#CC6222]">Estimated:</span> ${lastHourlyRate * bookingHours}</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-3 mb-4 text-sm">
        ...
        <div className="flex gap-4 mb-4">
          <button
            ...
            className={`pb-2 font-medium ${activeTab === 'upcoming' ? 'text-[#CC6222] border-b-2 border-[#CC6222]' : 'text-gray-500'}`}
          >
            Upcoming ({upcomingBookings.length})
          </button>
          <button
            onClick={() => setActiveTab('past')}
            className={`pb-2 font-medium ${activeTab === 'past' ? 'text-[#CC6222] border-b-2 border-[#CC6222]' : 'text-gray-500'}`}
          >
        ...
        <div className="space-y-3">
          {(activeTab === 'upcoming' ? upcomingBookings : pastBookings).map((booking) => {
            ...
            return (
              <div
                key={booking.id}
                className={`bg-white rounded-xl border transition-all ${isExpanded ? 'border-[#CC6222] shadow-md' : 'border-gray-200'}`}
              >
                {/* Tappable header */}
                <button
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-[#CC6222]">{formatDate(booking.start_time)}</p>
                  ...
                  <div className="px-4 pb-4 border-t border-gray-100">
                    <div className="grid grid-cols-2 gap-3 py-3 text-sm">
                      <div>
                        ...
                        <p className="text-[#CC6222] font-medium">{booking.service_type}</p>
                      </div>
                      <div>
                        <p className="text-gray-400 text-xs uppercase tracking-wide">Price</p>
                        <p className="text-[#CC6222] font-medium">${(booking.price / 100).toFixed(0)}</p>
                      </div>
                      <div>
                        <p className="text-gray-400 text-xs uppercase tracking-wide">Cleaner</p>
                        <p className="text-[#CC6222] font-medium">{booking.cleaners?.name || 'To be assigned'}</p>
                      </div>
                      <div>
                        <p className="text-gray-400 text-xs uppercase tracking-wide">Status</p>
                        <p className="text-[#CC6222] font-medium">{statusLabel}</p>
                      </div>
                      {booking.recurring_type && (
                        <div className="col-span-2">
                          <p className="text-gray-400 text-xs uppercase tracking-wide">Schedule</p>
                          <p className="text-[#CC6222] font-medium capitalize">{booking.recurring_type}</p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                      {activeTab === 'upcoming' && canReschedule(booking) && !doNotService && (
                        <button
                          ...
                          className="w-full py-2.5 bg-[#CC6222] text-white rounded-lg font-medium hover:bg-[#CC6222]/90"
                        >
                          Reschedule
                        </button>
                      )}
                      ...
                      <a
                        href="sms:9547103636"
                        className="w-full py-2.5 border border-gray-300 rounded-lg text-[#CC6222] font-medium text-center hover:bg-gray-50"
                      >
