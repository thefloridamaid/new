              ...
              <>
                ...
                {bookingDate && isSameDay(bookingDate) && (
                  <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4 mb-4">
                    ...
                    <div className="flex gap-3 mt-3">
                      <a href="tel:8333526243" className="flex-1 py-2 bg-yellow-600 text-white rounded-lg text-center font-medium text-sm">Call (833) 352-6243</a>
                      <a href="sms:8333526243" className="flex-1 py-2 bg-yellow-600 text-white rounded-lg text-center font-medium text-sm">Text (833) 352-6243</a>
                    </div>
                  </div>
                )}
