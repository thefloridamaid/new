      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center max-w-sm">
            ...
            <h2 className="text-2xl font-bold text-[#D4540A] mb-2">All set!</h2>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto p-4 pt-6">
        <form onSubmit={handleSubmit} onFocusCapture={trackStart} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          <h2 className="text-xl font-bold text-[#D4540A]">Your Information</h2>

          <div>
            <label className="block text-sm font-medium text-[#D4540A] mb-1">Full Name *</label>
            <input
              type="text"
              required
              value={form.name}
          ...
          <div>
            <label className="block text-sm font-medium text-[#D4540A] mb-1">Apt / Unit</label>
            <input
              type="text"
              value={form.apt}
          ...
          <div className="border-t border-gray-200 pt-5">
            <label className="block text-sm font-medium text-[#D4540A] mb-2">Referred by someone? <span className="text-gray-400 font-normal">(optional)</span></label>
