  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    if (res.ok) {
      ...
      if (data.exists) {
        ...
        setError('No account found with this phone number. Call (954) 710-3636 to book.')
      }
    } else {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold text-[#CC6222]">Client Portal</h1>
        ...
        {step === 'login' ? (
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border rounded-lg text-[#CC6222] text-lg"
          ...
          <form onSubmit={handlePinSubmit} className="space-y-4">
            {clientEmail ? (
              ...
              <p className="text-sm text-gray-600 text-center mb-4">
                No email on file. Call <a href="tel:9547103636" className="text-[#CC6222] font-medium">(954) 710-3636</a> to add your email and enable login.
              </p>
            )}
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border rounded-lg text-[#CC6222] text-center text-2xl tracking-widest"
                placeholder="000000"
                maxLength={6}
                required
              />
            ...
            <button
              ...
              className="w-full py-2 text-gray-500 text-sm hover:text-[#CC6222]"
            >
              ← Back
            </button>
          </form>
        ...
        <div className="mt-6 pt-6 border-t text-center">
          <p className="text-sm text-gray-500">
            New client?{' '}
            <a href="/clients/new" className="text-[#CC6222] hover:underline">Book your first cleaning</a>
          </p>
        </div>
