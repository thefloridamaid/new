...
export default function ReferralSignupPage() {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <p className="text-2xl font-bold text-[#CC6222]">{refCode}</p>
          </div>
          ...
          <div className="bg-[#34D399]/20 rounded-lg p-4 mb-6">
            <p className="text-sm text-[#CC6222] mb-2">Your referral link</p>
            <p className="text-sm font-mono text-[#CC6222] break-all">https://www.thefloridamaid.com/clients?ref={refCode}</p>
            <button
              onClick={copyLink}
              className="mt-3 px-4 py-2 bg-[#CC6222] text-white rounded-lg text-sm hover:bg-[#CC6222]/90"
            >
              Copy Link
            </button>
          </div>
          ...
          <div className="space-y-3">
            <Link
              ...
              className="block w-full py-3 bg-[#CC6222] text-white rounded-lg font-medium hover:bg-[#CC6222]/90"
            >
              Go to My Dashboard
            </Link>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-[#CC6222] text-white py-6 px-4">
      ...
      <div className="max-w-md mx-auto py-8 px-4">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-bold text-[#CC6222] mb-6">Sign Up to Start Earning</h2>
          ...
          <form onSubmit={handleSubmit} onFocusCapture={trackStart} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border rounded-lg text-[#CC6222]"
          ...
          <div className="mt-6 pt-6 border-t text-center">
            <p className="text-sm text-gray-500">
              Already a referrer?{' '}
              <Link href="/referral" className="text-[#CC6222] hover:underline">
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          <h3 className="font-bold text-[#CC6222] mb-4">How It Works</h3>
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="w-8 h-8 bg-[#CC6222] text-white rounded-full flex items-center justify-center flex-shrink-0">1</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="w-8 h-8 bg-[#CC6222] text-white rounded-full flex items-center justify-center flex-shrink-0">2</div>
              <div>
            ...
            <div className="flex gap-4">
              <div className="w-8 h-8 bg-[#CC6222] text-white rounded-full flex items-center justify-center flex-shrink-0">3</div>
              <div>
