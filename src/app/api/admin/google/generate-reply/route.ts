...
export async function POST(request: Request) {
  ...
  const prompt = `You are the owner of "The Florida Maid", a professional cleaning service in Florida. Write a short, warm reply to this Google review. Be genuine and professional. Keep it under 3 sentences. Don't be overly enthusiastic or use excessive exclamation marks.
