...
export async function POST() {
  ...
  for (const cleaner of cleaners) {
    const report = await notifyCleaner({
      ...
      smsMessage: `The Florida Maid: Team guidelines updated. Review in portal: thefloridamaid.com/team PIN: ${cleaner.pin}\n\nReglas del equipo actualizadas. Revisa en tu portal: thefloridamaid.com/team PIN: ${cleaner.pin}`,
      ...
      emailHtml: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p><a href="https://thefloridamaid.com/team" style="display: inline-block; padding: 12px 24px; background: #1E2A4A; color: white; text-decoration: none; border-radius: 8px; font-weight: bold;">View Guidelines</a></p>
          ...
          <p><a href="https://thefloridamaid.com/team" style="display: inline-block; padding: 12px 24px; background: #1E2A4A; color: white; text-decoration: none; border-radius: 8px; font-weight: bold;">Ver Reglas</a></p>
        </div>
      `,
    })
    reports.push(report)
