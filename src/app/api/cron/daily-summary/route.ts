          ...
          const html = `
            <div style="font-family: sans-serif; max-width: 500px;">
              ...
              <p style="margin-top: 20px;">
                <a href="https://www.thefloridamaid.com/admin/bookings" style="background: #000; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px;">Extend in Dashboard</a>
              </p>
            </div>
          `
