  ...
  const broadcastHtml = `
    <div style="font-family: sans-serif; max-width: 500px;">
      ...
      <div style="padding: 20px; text-align: center;">
        <a href="https://www.thefloridamaid.com/team" style="display: inline-block; background: #dc2626; color: white; padding: 16px 32px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 18px;">
          CLAIM NOW / RECLAMAR
        </a>
