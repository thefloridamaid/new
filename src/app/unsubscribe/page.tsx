      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            You will no longer receive {channel === 'sms' ? 'text messages' : 'emails'} from The Florida Maid Cleaning Service Cleaning Service,
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-md w-full text-center">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-5 text-left">
          <p className="text-amber-800 text-sm font-semibold mb-2">This will stop ALL {channel === 'sms' ? 'text messages' : 'emails'} from The Florida Maid Cleaning Service Cleaning Service, including:</p>
