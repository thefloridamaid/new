...
// Warm, friendly, personal — Selena with The Florida Maid checking in
...
export const OUTREACH_MOMENTS: OutreachMoment[] = [
  // 1. New Year
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy new year — hope the holidays were amazing. Wishing you a great start to the year!",
    ],
  },
  // 2. First day of spring
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy first day of spring! Hope you're enjoying the warmer weather. Have a great day!",
    ],
  },
  // 3. National Puppy Day — Mar 23
  {
    ...
    petOnly: 'dog',
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy National Puppy Day — hope {pet} is living the good life! Have a great day!",
    ],
  },
  // 4. National Pet Day — Apr 11
  {
    ...
    petAny: true,
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy National Pet Day — hope {pet} is getting spoiled today! Have a great one!",
    ],
  },
  // 5. Memorial Day weekend
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy Memorial Day weekend! Hope you get to relax and enjoy it. Take care!",
    ],
  },
  // 6. First day of summer
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy first day of summer! Hope you have some fun plans. Enjoy the season!",
    ],
  },
  // 7. July 4th
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy 4th of July! Hope you have an amazing holiday!",
    ],
  },
  // 8. International Cat Day — Aug 8
  {
    ...
    petOnly: 'cat',
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy International Cat Day — hope {pet} is ruling the house as usual! Have a great day!",
    ],
  },
  // 9. National Dog Day — Aug 26
  {
    ...
    petOnly: 'dog',
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy National Dog Day — hope {pet} is getting extra belly rubs today! Have a great one!",
    ],
  },
  // 10. Labor Day weekend
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy Labor Day weekend! Hope you enjoy the last bit of summer. Take care!",
    ],
  },
  // 11. First day of fall
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy first day of fall! Hope you're doing great. Here's to a good season!",
    ],
  },
  // 12. National Cat Day — Oct 29
  {
    ...
    petOnly: 'cat',
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy National Cat Day — hope {pet} is getting spoiled today! Take care!",
    ],
  },
  // 13. Thanksgiving
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy Thanksgiving! Hope you're enjoying the day with people you love. Take care!",
    ],
  },
  // 14. Christmas
  {
    ...
    messages: [
      "Hi {name}! Selena with The Florida Maid. Merry Christmas! Wishing you a wonderful holiday. Take care!",
    ],
  },
  // 15. New Year's Eve
  {
    ...
    messages: [
      "Hey {name}, it's Selena with The Florida Maid! Happy New Year's Eve — wishing you an amazing year ahead!",
    ],
  },
]
