...
export function commonServiceFAQs(service: Service): { question: string; answer: string }[] {
  return [
    ...
    { question: 'How do I book a cleaning?', answer: 'Text or call (954) 710-3636. Tell us your address, preferred date, and any special requests. We\'ll confirm your appointment and match you with a cleaner, usually within the hour. You can also book online at thefloridamaid.com/clients/new.' },
